---
name: unslop
description: Cut AI tells from writing and add human voice. Use whenever producing or editing prose a person will read - READMEs, docs, comments, commit messages, PR descriptions, issues, blog posts, emails, release notes - and whenever the user asks to unslop, de-AI, humanize, or tighten writing. Apply before handing prose back, not as a separate pass on request.
---
