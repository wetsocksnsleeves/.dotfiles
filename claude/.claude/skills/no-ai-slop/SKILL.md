...
Run this alongside the `unslop` skill, not instead of it: `unslop` covers puffery, AI vocabulary, and formatting tells (em dashes, curly quotes, title case) this skill doesn't enumerate. Apply both pattern lists to the same pass.
